...
const data01 = [{
  id: 0, name: 'Chrome', value: 1290, fill: '#4ce1b6',
}, {
  id: 1, name: 'Safari', value: 990, fill: '#70bbfd',
}, {
  id: 2, name: 'Mozilla', value: 2043, fill: '#f6da6e',
}, {
  id: 3, name: 'IE', value: 1543, fill: '#ff4861',
}];
  ...
  return (
    ...
    >
      <div className="dashboard__visitors-chart">
        <p className="dashboard__visitors-chart-title">Total visitors <span>on 08.11.2021</span></p>
        <p className="dashboard__visitors-chart-number">5 866</p>
